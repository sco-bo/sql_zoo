...
--10. Show who won a 'Medicine' prize in an early year 
...
--13. List the winners, year and subject where the winner starts with 
	-- Sir. Show the most recent first, then by name order
SELECT winner, yr, subject
FROM nobel
WHERE winner LIKE 'Sir%'
ORDER BY yr DESC;

--14. Show the 1984 winners and subject ordered by subject and winner
