...
--4. The query shown gives the number of routes that visit either London 
	-- Road (149) or Craiglockhart (53). Run the query and notice the 
	-- two services that link these stops have a count of 2. Add a HAVING 
...
--9. Give a distinct list of the stops which may be reached from 
	-- 'Craiglockhart' by taking one bus, including 'Craiglockhart' 
	-- itself, offered by the LRT company. Include the company and bus 
...
--10. Find the routes involving two buses that can go from Craiglockhart 
	-- to Sighthill. Show the bus no. and company for the first bus, the 
	-- name of the stop for the transfer, and the bus no. and company for
	-- the second bus
