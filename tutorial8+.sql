...
--4. Show the subject and total number of students who responded to 
	-- question 22 for each of the subjects '(8) Computer Science' 
...
--6. Show the percentage of students who A_STRONGLY_AGREE to question 22 
	-- for the subject '(8) Computer Science' show the same figure for 
	-- the subject '(H) Creative Arts and Design'. Use the ROUND function 
	-- to show the percentage without decimal places
...
--8. Show the institution, the total sample size and the number of 
	-- computing students for institutions in Manchester for 
	-- 'Q01'
SELECT institution, SUM(sample), SUM(
	CASE subject
		WHEN '(8) Computer Science' THEN sample
		ELSE 0
	END
	)
FROM nss 
